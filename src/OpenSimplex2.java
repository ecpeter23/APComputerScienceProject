...
// This is a 2d perlin noise library (OpenSimplex 2) that I am using to generate the map, the library is unlicensed and is free to use
// It takes a point (x, y) and a seed and outputs a number between -1 and 1, 
// Github (With examples): https://github.com/KdotJPG/OpenSimplex2
